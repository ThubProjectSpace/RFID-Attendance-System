                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <!-- <li>
                         ...
                         <li>
                            <a href="sms.php"><i class="fa fa-comments-o fa-fw nav_icon"></i> SMS </a>
                        </li>-->
                         <li>
                            <a href="approval.php"><i class="fa fa-bell-o fa-fw nav_icon"></i>Leave Notifications</a>
                        </li>
                        <?php
                          }
                          ...
                          <li>
                           ...
                           <li>
                            <a href="total_leave.php"><i class="fa fa-tasks fa-fw nav_icon"></i>Total Leave</a>
                        </li>
                        <?php
                    }
                    ?>
                        ...
                        <li class="m_2"><a href="settings.php"><i class="fa fa-wrench fa-fw nav_icon"></i> Settings</a></li>
                        <li class="m_2"><a href="logout.php"><i class="fa fa-lock fa-fw nav_icon"></i> Logout</a></li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
            </div>
