        ...
        ?>
            ...
            <form method="post">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control1" name="type" required>
                ...
                <div class="form-group">
                  ...
                  <textarea name="reason" class="form-control1" rows="6" ></textarea>
                </div>         
                <div class="form-group">
         ...
         <?php
           ...
           if (isset($_POST['bt'])){
            ...
            $query = "insert into leave_perm set staff_id='".$_POST['staff']."',rf_id='".$_POST['rf']."',firstname='".$_POST['fname']."',lastname='".$_POST['lname']."',from_date='".$_POST['date1']."',to_date='".$_POST['date2']."',date='".$_POST['date']."',type_of_reason='".$_POST['type']."',reason='".$_POST['reason']."',status='1',action='-' ";
