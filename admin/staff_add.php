            ...
            <form method="post">
              <fieldset>
                <div class="form-group">
                  ...
                  <input type="text"  name="st" class="form-control1"  required="" autofocus value="<?php echo $fetch['staff_id']; ?>" autocomplete="off">
                </div>
                <div class="form-group">
                  <label class="control-label normal">RFID</label>
                  <input type="number"  name="rf" class="form-control1"  required="" autofocus value="<?php echo $fetch['rf_id']; ?>">
                </div>
                <div class="form-group">
